import {
  ...
  tidy,
  util_exports
} from "./chunk-HFFBBMKH.js";
import "./chunk-AC2VUBZ6.js";

// node_modules/@tensorflow-models/knn-classifier/dist/knn-classifier.esm.js
...
var KNNClassifier = (
  /** @class */
  function() {
    function KNNClassifier2() {
      this.classDatasetMatrices = {};
      this.classExampleCount = {};
      this.labelToClassId = {};
      this.nextClassId = 0;
    }
    KNNClassifier2.prototype.addExample = function(example, label) {
      var _this = this;
      if (this.exampleShape == null) {
        this.exampleShape = example.shape;
      }
      if (!util_exports.arraysEqual(this.exampleShape, example.shape)) {
        throw new Error("Example shape provided, " + example.shape + " does not match " + ("previously provided example shapes " + this.exampleShape + "."));
      }
      ...
      tidy(function() {
        ...
        if (_this.classDatasetMatrices[label] == null) {
          _this.classDatasetMatrices[label] = reshape(normalizedExample, [1, exampleSize]);
        } else {
    ...
    KNNClassifier2.prototype.similarities = function(input) {
      var _this = this;
    ...
    KNNClassifier2.prototype.predictClass = function(input, k) {
      if (k === void 0) {
        k = 3;
      }
          ...
          switch (_b.label) {
            case 0:
              ...
              if (this.getNumExamples() === 0) {
                throw new Error("You have not added any examples to the KNN classifier. Please add examples before calling predictClass.");
              }
              knn = tidy(function() {
                return cast(_this.similarities(input), "float32");
              });
    ...
    KNNClassifier2.prototype.clearClass = function(label) {
    ...
    KNNClassifier2.prototype.clearAllClasses = function() {
      for (var label in this.classDatasetMatrices) {
        this.clearClass(label);
      }
    };
    KNNClassifier2.prototype.getClassExampleCount = function() {
      return this.classExampleCount;
    };
    KNNClassifier2.prototype.getClassifierDataset = function() {
      return this.classDatasetMatrices;
    };
    KNNClassifier2.prototype.getNumClasses = function() {
      return Object.keys(this.classExampleCount).length;
    };
    KNNClassifier2.prototype.setClassifierDataset = function(classDatasetMatrices) {
      this.clearTrainDatasetMatrix();
    ...
    KNNClassifier2.prototype.calculateTopClass = function(topKIndices, kVal) {
      var topLabel;
      var confidences = {};
      if (topKIndices == null) {
        return {
    ...
    KNNClassifier2.prototype.clearTrainDatasetMatrix = function() {
      if (this.trainDatasetMatrix != null) {
        this.trainDatasetMatrix.dispose();
        this.trainDatasetMatrix = null;
      }
    };
    KNNClassifier2.prototype.normalizeVectorToUnitLength = function(vec) {
      return tidy(function() {
        var sqrtSum = norm(vec);
        return div(vec, sqrtSum);
      });
    };
    KNNClassifier2.prototype.getNumExamples = function() {
      var total = 0;
      for (var label in this.classDatasetMatrices) {
    ...
    KNNClassifier2.prototype.dispose = function() {
      this.clearTrainDatasetMatrix();
      for (var label in this.classDatasetMatrices) {
        this.classDatasetMatrices[label].dispose();
      }
    };
    return KNNClassifier2;
  }()
);
function create() {
...
@tensorflow-models/knn-classifier/dist/knn-classifier.esm.js:
  (**
      * @license
...
*/
//# sourceMappingURL=@tensorflow-models_knn-classifier.js.map
